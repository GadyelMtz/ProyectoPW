    ...
    <Fragment>
      <div className="contenedorDePrincipal">
        ...
        <div id="mensajeBienvenida">
          ...
          En este espacio dedicado exclusivamente a ti, podrás explorar una
          variedad<br></br>
          de recursos diseñados para acompañarte en tu trayectoria después de
          <br></br>
          graduarte. Descubre oportunidades profesionales, mantente conectado
          con la<br></br>
          comunidad de egresados, y accede a valiosa información que impulsará
          tu<br></br>
          éxito en el mundo laboral.<br></br>
          <h2>
            ¡Estamos emocionados de seguir siendo parte<br></br>
            de tu historia después del ITTepic!
          </h2>
        </div>
