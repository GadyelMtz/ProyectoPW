...
const MenuEgresado = () => {
  ...
  return (
    <Fragment>
      <div class="contenedorDeEgresado">
              ...
              >
                ...
                <div class="offcanvas-body d-flex flex-column justify-content-between px-0">
                  <ul class="navbar-nav fs-5 justify-content-evenly">
                    ...
                    <li class="nav-item p-3 py-md-1">
                      <Link
                        to={`/login/menu/${noControl}/trabajo`}
                        class="nav-link"
                      >
                        Bolsa de trabajo
                      </Link>
              ...
              <div class="titulacion">
                <div class="titulacion-item">
                  ...
                  <div class="titulacion-info">
                    ...
                    <p>
                      ...
                      analizan su experiencia práctica en un entorno profesional
                      específico, como empresas o instituciones. Este informe
                      detallado resalta las habilidades adquiridas, los desafíos
                      enfrentados y las soluciones propuestas durante el periodo
                      de residencia, siendo una herramienta crucial para evaluar
                ...
                <div class="titulacion-item">
                  ...
                  <div class="titulacion-info">
                    ...
                    <p>
                      La titulación por tesis es un método común en la educación
                      superior donde los estudiantes investigan un tema
                      específico en profundidad, realizan un estudio exhaustivo,
                      recopilan datos, analizan información relevante y
                      presentan sus hallazgos en un documento formal. Esta tesis
                      suele contribuir al conocimiento existente en el campo y
                      demuestra la capacidad del estudiante para realizar
                      investigación independiente y avanzada.
                    </p>
                  </div>
                </div>
                ...
                <div class="titulacion-item">
                  ...
                  <div class="titulacion-info">
                    ...
                    <p>
                      ...
                      analizar resultados y presentar conclusiones. Este enfoque
                      práctico les permite aplicar conocimientos teóricos a
                      situaciones reales, contribuyendo al campo de estudio y
                      obteniendo su título mediante la realización exitosa del
                      proyecto.
                    </p>
                  </div>
                </div>
                ...
                <div class="titulacion-item">
                  ...
                  <div class="titulacion-info">
                    ...
                    <p>
                      ...
                      necesidad de cursar todos los créditos o asignaturas de un
                      plan de estudios. El Examen General para el Egreso de la
                      Licenciatura (EGEL) del CENEVAL evalúa los conocimientos,
                      habilidades y competencias adquiridas durante la carrera.
                      Los estudiantes que demuestran un dominio satisfactorio
                      del contenido pueden obtener su título universitario a
